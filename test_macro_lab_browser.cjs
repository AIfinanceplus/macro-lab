...
(async () => {
  ...
  try {
    ...
    await page.locator('#mode').selectOption('fixture');
    await page.locator('#model-mode').selectOption('deterministic');
    ...
    assert.equal(await page.locator('[data-arch-node]').count(), 27);
